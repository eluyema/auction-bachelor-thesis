...
class AuctionInitialBidsMapper {
    ...
    static mapToVerticalListItems(results: AuctionInitialBid[], options = { showLabelForMax: false }): VerticalListItemProps[] {
        return results.map(result => this.mapResultToVerticalListItem(result, options));
    }

    private static mapResultToVerticalListItem(result: AuctionInitialBid, options = { showLabelForMax: false }): VerticalListItemProps {
    ...
    static mapToTableDataRows(results: AuctionInitialBid[], options = { showLabelForMax: false }): TableRowProps[] {
        const { showLabelForMax } = options;
